...
export class NetworksCollectionSync extends BaseCollectionSync {
  ...
  protected async generateAutoPoster(
    ...
    try {
      ...
      const posterConfig = {
        collectionName,
        collectionType: platformName, // Always use platform name for proper theming
      ...
      logger.info(
        `Successfully generated and applied poster for Networks collection: ${collectionName}`,
        {
          label: 'Networks Collections',
          platform: platformName,
      ...
      logger.error(
        `Failed to generate autoPoster for Networks collection: ${collectionName}`,
        {
          label: 'Networks Collections',
          error: error instanceof Error ? error.message : String(error),
        }
