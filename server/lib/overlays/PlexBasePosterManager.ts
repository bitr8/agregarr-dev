...
// Seasons and episodes always use Plex: a season guid's TMDB id is in the
// season namespace, and title cards have no TMDB equivalent. Callers record this value.
